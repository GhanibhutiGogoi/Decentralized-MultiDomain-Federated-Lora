...
The classifier dense-layer and output-layer weights and biases are averaged with the same weights. Its intervening tanh and dropout operations have no trainable parameters.
