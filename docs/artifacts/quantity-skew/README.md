...
The completed 38-page manuscript was compiled and rendered on gpu003, and all pages passed visual review with no final layout/reference warnings. The [paper build record](paper-build/README.md) contains source/figure/PDF hashes and review coverage.
