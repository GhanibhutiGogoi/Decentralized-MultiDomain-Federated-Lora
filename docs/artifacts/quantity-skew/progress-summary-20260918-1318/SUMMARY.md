...
|---|---:|---:|---:|---:|---:|
| Adaptive ranks, sample weights | 4 | 94.295 ± 0.254 | 93.922 ± 0.209 | 1.292 | 4/4 |
| Adaptive ranks, uniform weights | 4 | 94.266 ± 0.094 | 93.893 ± 0.549 | 1.296 | 4/4 |
...
| Fixed heterogeneous ranks, sample weights | 4 | 94.438 ± 0.115 | 94.295 ± 0.196 | 1.468 | 4/4 |
| Fixed heterogeneous ranks, uniform weights | 4 | 94.581 ± 0.254 | 94.237 ± 0.355 | 1.468 | 4/4 |
...
|---|---:|---:|---:|
| primary_adaptive_sample_minus_declora16 | 4 | -0.201 ± 0.342 | [-0.746, 0.344] |
| adaptive_sample_minus_feasible_declora4 | 4 | -0.172 ± 0.344 | [-0.719, 0.375] |
| adaptive_sample_minus_product16_sample | 4 | -0.459 ± 0.363 | [-1.036, 0.118] |
| adaptation_at_uniform_weights | 4 | -0.315 ± 0.196 | [-0.627, -0.004] |
| adaptation_at_sample_weights | 4 | -0.143 ± 0.217 | [-0.489, 0.202] |
| sample_weighting_at_fixed_ranks | 4 | -0.143 ± 0.196 | [-0.455, 0.168] |
| sample_weighting_at_adaptive_ranks | 4 | 0.029 ± 0.196 | [-0.283, 0.340] |
| adaptation_main_effect | 4 | -0.229 ± 0.105 | [-0.396, -0.063] |
| sample_weighting_main_effect | 4 | -0.057 ± 0.081 | [-0.186, 0.072] |
| adaptation_by_weighting_interaction | 4 | 0.172 ± 0.357 | [-0.395, 0.739] |
...
- `/home/gogoi/ahlora-quantity-20260917/runs/full-v1-quantity-adaptive_uniform-seed46` — incomplete: Missing run artifacts: rounds.jsonl
- `/home/gogoi/ahlora-quantity-20260917/runs/full-v1-quantity-fixed_sample-seed46` — incomplete: Missing run artifacts: rounds.jsonl
- `/home/gogoi/ahlora-quantity-20260917/runs/full-v1-quantity-fixed_uniform-seed46` — incomplete: Missing run artifacts: rounds.jsonl
