...
The research is presented in two standalone papers: [original multi-domain study](../../paper/multidomain/main.pdf) and [new quantity-skew study](../../paper/quantity-skew/main.pdf). Each has its own source, methodology, evaluation rules, figures and conclusion. The [paper index](../../paper/README.md) identifies current deliverables and the archived combined version.
