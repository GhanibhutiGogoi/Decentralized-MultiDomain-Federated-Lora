...
The earlier [methodology exploration](docs/artifacts/methodology-exploration/README.md) is also complete. It isolates optimization and repeated rank-projection losses, preserves failed residual repairs, and shows that a successful full-state gradient-sharing control does not establish the original heterogeneous-rank resource claim. The [paper](paper/main.pdf) reports these studies with their separate protocols and conclusions.
